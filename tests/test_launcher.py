...
class TestFabricLauncherMethods(unittest.TestCase):
    ...
    def test_deploy_artifacts(self, mock_deployer_class, mock_fabric):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            result = launcher.deploy_artifacts(
            ...
            mock_deployer_instance.deploy_items.assert_called_once_with(
                ["Lakehouse", "Notebook"]
            )
...
class TestFabricLauncherDownloadAndDeploy(unittest.TestCase):
    ...
    def test_download_and_deploy_basic(self, mock_report_class, mock_deployer_class, 
                                       mock_downloader_class, mock_fabric):
    ...
    @patch('fabric_launcher.launcher.FabricDeployer')
    @patch('fabric_launcher.launcher.DeploymentReport')
    def test_download_and_deploy_with_item_type_stages(self, mock_report_class, 
                                                        mock_deployer_class,
    ...
    @patch('fabric_launcher.launcher.FabricDeployer')
    @patch('fabric_launcher.launcher.DeploymentReport')
    def test_download_and_deploy_single_stage_with_item_type_stages(self, mock_report_class,
                                                                     mock_deployer_class,
                                                                     mock_downloader_class,
                                                                     mock_fabric):
